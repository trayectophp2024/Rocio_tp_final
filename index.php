...
<style>
@import url('https://fonts.googleapis.com/css2?family=Kanit:ital,wght@0,400;0,500;1,400&family=Mulish:ital,wght@0,200..1000;1,200..1000&display=swap');
</style>
  </head>
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu ">
            <li><a class="dropdown-item" href="index.php?sec=categoria&cat=1">Jean</a></li>
            <li><a class="dropdown-item" href="index.php?sec=categoria&cat=2">Remeras</a></li>
            <li><a class="dropdown-item" href="index.php?sec=categoria&cat=3">Camperas</a></li>
          </ul>
        </li>
        <li class="nav-item ">
